...
public class RoomDAO extends DBContext {
    ...
    public Room getRoomById(int maPhong) {
        String sql = "SELECT * FROM dbo.Phong WHERE MaPhong = ?";
    ...
    public List<Room> getRoomsByCinema(int maRap) {
        List<Room> rooms = new ArrayList<>();
        String sql = "SELECT * FROM dbo.Phong WHERE MaRap = ? ORDER BY TenPhong";
    ...
    public boolean addRoom(Room room) {
        String sql = "INSERT INTO dbo.Phong (MaRap, TenPhong, SoLuongGhe) VALUES (?, ?, ?)";
    ...
    public boolean updateRoom(Room room) {
        String sql = "UPDATE dbo.Phong SET MaRap = ?, TenPhong = ?, SoLuongGhe = ? WHERE MaPhong = ?";
