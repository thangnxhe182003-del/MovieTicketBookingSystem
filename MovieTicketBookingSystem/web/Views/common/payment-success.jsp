...
<div style="min-height:60vh;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:12px;">
    ...
    <a class="btn" href="${pageContext.request.contextPath}/order-history" style="background:#e50914;color:#fff;padding:10px 16px;border-radius:6px;text-decoration:none;">Xem lịch sử đặt vé</a>
</div>
