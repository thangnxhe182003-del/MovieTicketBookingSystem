                ...
                <div class="detail-header">
                    ...
                    <div class="movie-info-section">
                        ...
                        <div class="action-buttons">
                            <c:if test="${not empty showtimes}"><a href="booking?action=selectShowtime&maPhim=${movie.maPhim}" class="btn btn-primary">🎫 Đặt vé ngay</a></c:if>
                            ...
                            <c:forEach var="showtime" items="${showtimes}">
                                <div class="showtime-card">
                                    <div class="showtime-date">
                                        <% if (request.getAttribute("showtime") != null) { %>
                                        <% } %>
                                        <% {
                                            model.Showtime st = (model.Showtime) pageContext.findAttribute("showtime");
                                            if (st != null && st.getNgayChieu() != null) {
                                                out.print(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy").format(st.getNgayChieu()));
                                            }
                                        } %>
                                    </div>
                                    <div class="showtime-time">
                                        <% {
                                            model.Showtime st = (model.Showtime) pageContext.findAttribute("showtime");
                                            if (st != null && st.getGioBatDau() != null) {
                                                out.print(java.time.format.DateTimeFormatter.ofPattern("HH:mm").format(st.getGioBatDau()));
                                            }
                                        } %>
                                    </div>
