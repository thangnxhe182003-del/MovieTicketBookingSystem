...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .movie-subinfo { font-size: 12px; color: #666; }
                                ...
                                <div class="movie-card">
                                    ...
                                    <div class="movie-meta">
                                        ...
                                        <div class="movie-subinfo">
                                            ...
                                            <span style="margin-left:8px;"><c:out value="${movie.thoiLuong}"/> phút</span>
                                        </div>
                                    ...
                                    <div class="card-actions">
                                        <a class="btn-primary" href="${movieDetailUrl}">Đặt vé ngay</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
                                    ...
                                    <div class="movie-meta">
                                        ...
                                        <div class="movie-subinfo">
                                            ...
                                            <c:if test="${movie.ngayKhoiChieu != null}">
                                                <span style="margin-left:8px;color:#e67e22;">
